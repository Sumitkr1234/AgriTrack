...
<head>
    ...
    <title>Manage Stock - CropMaster</title>
    ...
    <link rel="stylesheet" href="<?php echo (strpos($_SERVER['REQUEST_URI'], '/CropMaster') !== false) ? '/CropMaster/css/manage_stock.css' : '../css/manage_stock.css'; ?>?v=<?php echo time(); ?>">
</head>
<body>
