...
<head>
    ...
    <title>Edit Product - CropMaster</title>
    ...
    <link rel="stylesheet" href="<?php echo (strpos($_SERVER['REQUEST_URI'], '/CropMaster') !== false) ? '/CropMaster/css/add_product.css' : '../css/add_product.css'; ?>?v=<?php echo time(); ?>">
</head>
<body>
